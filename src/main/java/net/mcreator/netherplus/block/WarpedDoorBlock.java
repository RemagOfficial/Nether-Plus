...
public class WarpedDoorBlock extends NetherplusModElements.ModElement {
	@ObjectHolder("netherplus:warped_door")
	public static final Block block = null;
	public WarpedDoorBlock(NetherplusModElements instance) {
		super(instance, 41);
	}
