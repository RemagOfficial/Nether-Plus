...
public class BlackstoneStairsBlock extends NetherplusModElements.ModElement {
	@ObjectHolder("netherplus:blackstone_stairs")
	public static final Block block = null;
	public BlackstoneStairsBlock(NetherplusModElements instance) {
		super(instance, 104);
	}
