...
public class StrippedCrimsonHyphaeBlock extends NetherplusModElements.ModElement {
	@ObjectHolder("netherplus:stripped_crimson_hyphae")
	public static final Block block = null;
	public StrippedCrimsonHyphaeBlock(NetherplusModElements instance) {
		super(instance, 16);
	}
