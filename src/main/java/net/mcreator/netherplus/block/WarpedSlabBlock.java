...
public class WarpedSlabBlock extends NetherplusModElements.ModElement {
	@ObjectHolder("netherplus:warped_slab")
	public static final Block block = null;
	public WarpedSlabBlock(NetherplusModElements instance) {
		super(instance, 38);
	}
