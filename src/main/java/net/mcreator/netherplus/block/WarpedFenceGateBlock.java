...
public class WarpedFenceGateBlock extends NetherplusModElements.ModElement {
	@ObjectHolder("netherplus:warped_fence_gate")
	public static final Block block = null;
	public WarpedFenceGateBlock(NetherplusModElements instance) {
		super(instance, 42);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("warped_fence_gate");
		}
