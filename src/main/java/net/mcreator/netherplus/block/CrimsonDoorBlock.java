...
public class CrimsonDoorBlock extends NetherplusModElements.ModElement {
	@ObjectHolder("netherplus:crimson_door")
	public static final Block block = null;
	public CrimsonDoorBlock(NetherplusModElements instance) {
		super(instance, 69);
	}
