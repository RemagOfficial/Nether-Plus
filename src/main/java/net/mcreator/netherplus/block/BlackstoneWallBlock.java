...
public class BlackstoneWallBlock extends NetherplusModElements.ModElement {
	@ObjectHolder("netherplus:blackstone_wall")
	public static final Block block = null;
	public BlackstoneWallBlock(NetherplusModElements instance) {
		super(instance, 105);
	}
