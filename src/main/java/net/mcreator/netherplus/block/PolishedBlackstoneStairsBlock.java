...
public class PolishedBlackstoneStairsBlock extends NetherplusModElements.ModElement {
	@ObjectHolder("netherplus:polished_blackstone_stairs")
	public static final Block block = null;
	public PolishedBlackstoneStairsBlock(NetherplusModElements instance) {
		super(instance, 121);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("polished_blackstone_stairs");
		}
