...
public class WarpedRootsBlock extends NetherplusModElements.ModElement {
	@ObjectHolder("netherplus:warped_roots")
	public static final Block block = null;
	public WarpedRootsBlock(NetherplusModElements instance) {
		super(instance, 10);
	}
