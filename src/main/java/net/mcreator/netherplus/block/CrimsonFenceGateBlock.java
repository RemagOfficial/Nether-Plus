...
public class CrimsonFenceGateBlock extends NetherplusModElements.ModElement {
	@ObjectHolder("netherplus:crimson_fence_gate")
	public static final Block block = null;
	public CrimsonFenceGateBlock(NetherplusModElements instance) {
		super(instance, 70);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("crimson_fence_gate");
		}
