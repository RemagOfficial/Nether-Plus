...
public class BlackstoneSlabBlock extends NetherplusModElements.ModElement {
	@ObjectHolder("netherplus:blackstone_slab")
	public static final Block block = null;
	public BlackstoneSlabBlock(NetherplusModElements instance) {
		super(instance, 103);
	}
