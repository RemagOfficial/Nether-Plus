...
import net.mcreator.netherplus.procedures.BlueTreeSpawn2UpdateTickProcedure;
...
public class BlueTreeSpawn2Block extends NetherplusModElements.ModElement {
	@ObjectHolder("netherplus:blue_tree_spawn_2")
	public static final Block block = null;
	public BlueTreeSpawn2Block(NetherplusModElements instance) {
		super(instance, 91);
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("blue_tree_spawn_2");
		}
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				BlueTreeSpawn2UpdateTickProcedure.executeProcedure($_dependencies);
			}
		}
