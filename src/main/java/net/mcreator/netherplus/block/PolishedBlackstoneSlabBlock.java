...
public class PolishedBlackstoneSlabBlock extends NetherplusModElements.ModElement {
	@ObjectHolder("netherplus:polished_blackstone_slab")
	public static final Block block = null;
	public PolishedBlackstoneSlabBlock(NetherplusModElements instance) {
		super(instance, 120);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("polished_blackstone_slab");
		}
