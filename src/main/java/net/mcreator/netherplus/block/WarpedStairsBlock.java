...
public class WarpedStairsBlock extends NetherplusModElements.ModElement {
	@ObjectHolder("netherplus:warped_stairs")
	public static final Block block = null;
	public WarpedStairsBlock(NetherplusModElements instance) {
		super(instance, 37);
	}
