...
public class WarpedFenceBlock extends NetherplusModElements.ModElement {
	@ObjectHolder("netherplus:warped_fence")
	public static final Block block = null;
	public WarpedFenceBlock(NetherplusModElements instance) {
		super(instance, 39);
	}
