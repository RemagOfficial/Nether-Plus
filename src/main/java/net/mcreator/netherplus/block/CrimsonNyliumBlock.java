...
public class CrimsonNyliumBlock extends NetherplusModElements.ModElement {
	@ObjectHolder("netherplus:crimson_nylium")
	public static final Block block = null;
	public CrimsonNyliumBlock(NetherplusModElements instance) {
		super(instance, 6);
	}
