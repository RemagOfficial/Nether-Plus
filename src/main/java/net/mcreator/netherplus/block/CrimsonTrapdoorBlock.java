...
public class CrimsonTrapdoorBlock extends NetherplusModElements.ModElement {
	@ObjectHolder("netherplus:crimson_trapdoor")
	public static final Block block = null;
	public CrimsonTrapdoorBlock(NetherplusModElements instance) {
		super(instance, 68);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("crimson_trapdoor");
		}
