...
public class ChiseledPolishedBlackstoneBlock extends NetherplusModElements.ModElement {
	@ObjectHolder("netherplus:chiseled_polished_blackstone")
	public static final Block block = null;
	public ChiseledPolishedBlackstoneBlock(NetherplusModElements instance) {
		super(instance, 113);
	}
