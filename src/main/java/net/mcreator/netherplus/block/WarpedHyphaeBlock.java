...
public class WarpedHyphaeBlock extends NetherplusModElements.ModElement {
	@ObjectHolder("netherplus:warped_hyphae")
	public static final Block block = null;
	public WarpedHyphaeBlock(NetherplusModElements instance) {
		super(instance, 14);
	}
