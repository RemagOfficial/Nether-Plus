...
import net.mcreator.netherplus.world.dimension.NetherplusDimension;
import net.mcreator.netherplus.procedures.BlueTreeSpawn1UpdateTickProcedure;
...
public class BlueTreeSpawn1Block extends NetherplusModElements.ModElement {
	@ObjectHolder("netherplus:blue_tree_spawn_1")
	public static final Block block = null;
	public BlueTreeSpawn1Block(NetherplusModElements instance) {
		super(instance, 90);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		FlowersFeature feature = new DefaultFlowersFeature(BlockClusterFeatureConfig::deserialize) {
			...
			public boolean place(IWorld world, ChunkGenerator generator, Random random, BlockPos pos, BlockClusterFeatureConfig config) {
				...
				if (dimensionType == NetherplusDimension.type)
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			super(Effects.SATURATION, 0, Block.Properties.create(Material.PLANTS).tickRandomly().doesNotBlockMovement().sound(SoundType.GROUND)
					.hardnessAndResistance(0f, 0f).lightValue(0));
			setRegistryName("blue_tree_spawn_1");
		}
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				BlueTreeSpawn1UpdateTickProcedure.executeProcedure($_dependencies);
			}
		}
