...
public class CrimsonFungiBlock extends NetherplusModElements.ModElement {
	@ObjectHolder("netherplus:crimson_fungi")
	public static final Block block = null;
	public CrimsonFungiBlock(NetherplusModElements instance) {
		super(instance, 22);
	}
