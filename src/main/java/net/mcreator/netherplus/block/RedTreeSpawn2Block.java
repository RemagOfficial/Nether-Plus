...
import net.mcreator.netherplus.procedures.RedTreeSpawn2UpdateTickProcedure;
...
public class RedTreeSpawn2Block extends NetherplusModElements.ModElement {
	@ObjectHolder("netherplus:red_tree_spawn_2")
	public static final Block block = null;
	public RedTreeSpawn2Block(NetherplusModElements instance) {
		super(instance, 89);
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("red_tree_spawn_2");
		}
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				RedTreeSpawn2UpdateTickProcedure.executeProcedure($_dependencies);
			}
		}
