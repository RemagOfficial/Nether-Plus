...
public class StrippedWarpedStemBlock extends NetherplusModElements.ModElement {
	@ObjectHolder("netherplus:stripped_warped_stem")
	public static final Block block = null;
	public StrippedWarpedStemBlock(NetherplusModElements instance) {
		super(instance, 47);
	}
