...
public class PolishedBlackstoneBlock extends NetherplusModElements.ModElement {
	@ObjectHolder("netherplus:polished_blackstone")
	public static final Block block = null;
	public PolishedBlackstoneBlock(NetherplusModElements instance) {
		super(instance, 112);
	}
