...
public class CrimsonFenceBlock extends NetherplusModElements.ModElement {
	@ObjectHolder("netherplus:crimson_fence")
	public static final Block block = null;
	public CrimsonFenceBlock(NetherplusModElements instance) {
		super(instance, 67);
	}
