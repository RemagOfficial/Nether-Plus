...
public class WarpedStemBlock extends NetherplusModElements.ModElement {
	@ObjectHolder("netherplus:warped_stem")
	public static final Block block = null;
	public WarpedStemBlock(NetherplusModElements instance) {
		super(instance, 2);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(1.9999999999999998f, 2f).lightValue(0)
