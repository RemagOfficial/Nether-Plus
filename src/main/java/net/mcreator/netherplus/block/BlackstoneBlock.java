...
public class BlackstoneBlock extends NetherplusModElements.ModElement {
	@ObjectHolder("netherplus:blackstone")
	public static final Block block = null;
	public BlackstoneBlock(NetherplusModElements instance) {
		super(instance, 95);
	}
