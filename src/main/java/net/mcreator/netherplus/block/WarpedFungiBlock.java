...
public class WarpedFungiBlock extends NetherplusModElements.ModElement {
	@ObjectHolder("netherplus:warped_fungi")
	public static final Block block = null;
	public WarpedFungiBlock(NetherplusModElements instance) {
		super(instance, 21);
	}
