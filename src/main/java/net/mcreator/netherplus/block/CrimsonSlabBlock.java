...
public class CrimsonSlabBlock extends NetherplusModElements.ModElement {
	@ObjectHolder("netherplus:crimson_slab")
	public static final Block block = null;
	public CrimsonSlabBlock(NetherplusModElements instance) {
		super(instance, 66);
	}
