...
public class CrimsonHyphaeBlock extends NetherplusModElements.ModElement {
	@ObjectHolder("netherplus:crimson_hyphae")
	public static final Block block = null;
	public CrimsonHyphaeBlock(NetherplusModElements instance) {
		super(instance, 15);
	}
