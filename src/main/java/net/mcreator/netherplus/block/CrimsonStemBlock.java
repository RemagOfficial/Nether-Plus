...
public class CrimsonStemBlock extends NetherplusModElements.ModElement {
	@ObjectHolder("netherplus:crimson_stem")
	public static final Block block = null;
	public CrimsonStemBlock(NetherplusModElements instance) {
		super(instance, 5);
	}
