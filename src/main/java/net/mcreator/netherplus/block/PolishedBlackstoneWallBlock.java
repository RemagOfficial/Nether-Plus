...
public class PolishedBlackstoneWallBlock extends NetherplusModElements.ModElement {
	@ObjectHolder("netherplus:polished_blackstone_wall")
	public static final Block block = null;
	public PolishedBlackstoneWallBlock(NetherplusModElements instance) {
		super(instance, 122);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("polished_blackstone_wall");
		}
