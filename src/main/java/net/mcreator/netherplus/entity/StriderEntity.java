...
import net.mcreator.netherplus.procedures.StriderOnEntityTickUpdateProcedure;
...
public class StriderEntity extends NetherplusModElements.ModElement {
	public static EntityType entity = null;
	public StriderEntity(NetherplusModElements instance) {
		super(instance, 125);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire().size(0.9f, 1.7f)).build("strider")
						.setRegistryName("strider");
		elements.entities.add(() -> entity);
		elements.items.add(
				() -> new SpawnEggItem(entity, -52429, -10066330, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("strider_spawn_egg"));
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new ModelStriderModel(), 0.5f) {
				...
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("netherplus:textures/strider.png");
				}
			};
		});
	}
	public static class CustomEntity extends CreatureEntity {
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				StriderOnEntityTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
