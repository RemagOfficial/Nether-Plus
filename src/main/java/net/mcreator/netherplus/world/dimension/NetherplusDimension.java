...
package net.mcreator.netherplus.world.dimension;
...
import net.mcreator.netherplus.item.NetherplusItem;
...
public class NetherplusDimension extends NetherplusModElements.ModElement {
	@ObjectHolder("netherplus:netherplus")
	public static final ModDimension dimension = null;
	@ObjectHolder("netherplus:netherplus_portal")
	public static final CustomPortalBlock portal = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;
	public NetherplusDimension(NetherplusModElements instance) {
		super(instance, 92);
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("netherplus"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("netherplus:netherplus")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("netherplus:netherplus"), dimension, null, false);
		}
		type = DimensionType.byName(new ResourceLocation("netherplus:netherplus"));
	}

	@Override
	public void init(FMLCommonSetupEvent event) {
		dimensionBiomes = new Biome[]{ForgeRegistries.BIOMES.getValue(new ResourceLocation("netherplus:warped_forest")),
				ForgeRegistries.BIOMES.getValue(new ResourceLocation("netherplus:crimson_forest")),
				ForgeRegistries.BIOMES.getValue(new ResourceLocation("nether")),};
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new CustomPortalBlock());
		elements.items.add(() -> new NetherplusItem().setRegistryName("netherplus"));
	}
	...
	public static class CustomPortalBlock extends NetherPortalBlock {
		public CustomPortalBlock() {
			...
			setRegistryName("netherplus_portal");
		}
		...
		private TeleporterDimensionMod getTeleporterForDimension(Entity entity, BlockPos pos, ServerWorld nextWorld) {
			BlockPattern.PatternHelper bph = NetherplusDimension.CustomPortalBlock.createPatternHelper(entity.world, pos);
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("netherplus_portal", Vec3i::compareTo, 300);
	@SubscribeEvent
	public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
		try {
			...
			poi = (PointOfInterestType) method.invoke(null, "netherplus_portal",
	...
	public static class TeleporterDimensionMod implements ITeleporter {
		...
		public BlockPattern.PortalInfo placeInExistingPortal(BlockPos p_222272_1_, Vec3d p_222272_2_, Direction directionIn, double p_222272_4_,
			...
			return optional.map((p_226707_7_) -> {
				...
				BlockPattern.PatternHelper blockpattern$patternhelper = NetherplusDimension.CustomPortalBlock.createPatternHelper(this.world,
						blockpos);
	...
	public static class CustomDimension extends Dimension {
		...
		public Vec3d getFogColor(float cangle, float ticks) {
			return new Vec3d(0.2, 0.027450980392, 0.027450980392);
		}
